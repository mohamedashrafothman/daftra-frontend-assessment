...
const PokemonInfinityListing = () => {
	...
	const {
		...
		hasNextPage: hasPokemonNextPage,
		fetchNextPage: fetchPokemonNextPage,
		isFetchingNextPage: isPokemonFetchingNextPage,
					...
					{hasPokemonNextPage && (
						<div className="col-auto">
							<button
								...
								onClick={() => fetchPokemonNextPage()}
								disabled={isPokemonFetchingNextPage}>
								{isPokemonFetchingNextPage && (
									<span
								...
								<small>{`${isPokemonFetchingNextPage ? "Loading" : "Load"} more pokemon`}</small>
							</button>
						</div>
					)}
				</>
